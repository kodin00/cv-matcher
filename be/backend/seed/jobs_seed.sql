...
-- Imported from /Users/kodin/Downloads/jd_texts.csv
...
VALUES (
    ...
    'Company Not Specified',
    'Information Technology',
    'QA Automation Engineer bertanggung jawab memastikan kualitas produk Ruangguru yang melayani jutaan siswa di Indonesia. Lingkup pekerjaan: merancang test strategy dan test plan untuk fitur baru, mengembangkan automated test suite untuk web (Cypress) dan API (Postman/RestAssured), mengintegrasikan automated test ke CI/CD pipeline dengan Jenkins, melakukan exploratory testing dan bug investigation, serta berkolaborasi dengan developer untuk implement TDD/BDD practice. Kandidat memiliki pengalaman 2-4 tahun di QA automation, memahami testing pyramid (unit, integration, e2e) dan kapan menggunakan masing-masing, familiar dengan Agile/Scrum methodology, memiliki pemikiran kritis untuk identify edge case yang luput dari requirement. Sertifikasi ISTQB Foundation menjadi nilai tambah. Bersedia melakukan testing lintas device (iOS, Android, web responsive).',
